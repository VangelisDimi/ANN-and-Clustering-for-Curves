...
# os.system("make cluster UPDATE=\"Mean Vector\" ASSIGNMENT=Classic OUTPUT_FILE=encoded_cluster_update_Mean_Vector_assignment_Classic")
# os.system("make cluster UPDATE=\"Mean Vector\" ASSIGNMENT=LSH OUTPUT_FILE=encoded_cluster_update_Mean_Vector_assignment_LSH")
# os.system("make cluster UPDATE=\"Mean Vector\" ASSIGNMENT=Hypercube OUTPUT_FILE=encoded_cluster_update_Mean_Vector_assignment_Hypercube")
# os.system("make cluster UPDATE=\"Mean Frechet\" ASSIGNMENT=Classic OUTPUT_FILE=encoded_cluster_update_Mean_Frechet_assignment_Classic")
# os.system("make cluster UPDATE=\"Mean Frechet\" ASSIGNMENT=LSH OUTPUT_FILE=encoded_cluster_update_Mean_Frechet_assignment_LSH")